...
public class ChatUsersActivity extends AppCompatActivity implements ChatUsersRecyclerAdapter.onClickUserInterface{
        ...
        query.findInBackground(new FindCallback<ParseUser>() {
            ...
            public void done(List<ParseUser> objects, ParseException e) {
                ...
                if (e == null) {
                    ...
                    recyclerView.setAdapter(new ChatUsersRecyclerAdapter(users, ChatUsersActivity.this));
                    recyclerView.setLayoutManager(new LinearLayoutManager(ChatUsersActivity.this));
