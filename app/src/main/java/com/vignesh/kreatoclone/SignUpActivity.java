...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextInputLayout edtDomain, edtEmail, edtUserName, edtPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtDomain = findViewById(R.id.edtDomain_signUp);
    ...
    private void signUp() {
        ...
        user.put("domain", edtDomain.getEditText().getText().toString());
